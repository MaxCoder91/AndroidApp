...
public class AgEventos extends AppCompatActivity implements Response.Listener<JSONObject>, Response.ErrorListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ag_eventos);

        edtTitulo=findViewById(R.id.editTextTitle5);
        edtFecha=findViewById(R.id.editTextDate5);
        edtHoraIni=findViewById(R.id.editTextHour8);
        edtHoraFin=findViewById(R.id.editTextHour9);
        edtDesc=findViewById(R.id.editTextMultiLine5);
        btnAgendar=findViewById(R.id.buttonCreate4);
    ...
    public void agendarEvento(){
        ...
        if(edtTitulo.getText().toString().trim().equalsIgnoreCase("")){
            ...
            if(sqLiteDatabase!=null){
                ...
                cvalues.put("idTipo",2);
                cvalues.put("idCategoria",3);
                ...
                if(nfilas>0){
                    ...
                    cvalues2.put("idEvento",RescatarId(titulo,fecha,horaIni,horaFin,2,3));
